...
describe('BankingComponent', () => {
  ...
  it(`(U) setSacar(): shoud trasnfer poupanca from carteira`, () =>{
  ...
  it(`(U) setSacar(): shoud trasnfer poupanca dont have string (isNaN) or poupanca < value`, () =>{
  ...
  it(`(U) setDepositar(): shoud trasnfer carteira dont have string (isNaN) or carteira < value`, () =>{
